# CONSTITUTION — VisionEngine

Project-specific governance for the **VisionEngine** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
